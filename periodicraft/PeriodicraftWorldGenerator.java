...
//Copyright (C)2013 Jack Maloney Noah Schoolman
//
...
public class PeriodicraftWorldGenerator implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		...
		case Periodicraft.MarsID:
			...
			break;
		case Periodicraft.MercuryID:
			generateMercury(world, random, chunkX * 16, chunkZ * 16);
			break;
		case Periodicraft.EuropaID:
			generateEuropa(world, random, chunkX * 16, chunkZ * 16);
			break;
		case Periodicraft.TitanID:
			generateTitan(world, random, chunkX * 16, chunkZ * 16);
			break;

		}
	}

	private void generateTitan(World world, Random random, int x, int z) {
		...
		for(int k = 0; k < 6; k++) {
			...
			int ThoriumOreYCoord = random.nextInt(30);
			int ThoriumOreXCoord = x + random.nextInt(16);
			int ThoriumOreZCoord = z + random.nextInt(16);
			(new WorldGenMinable(Periodicraft.ThoriumOre.blockID, 4, 1)).generate(world, random, ThoriumOreXCoord, ThoriumOreYCoord, ThoriumOreZCoord);
		}

	}

	private void generateEuropa(World world, Random random, int x, int z) {
	...
	private void generateSurface(World world, Random random, int x, int z) {
		...
		for(int k = 0; k < 3; k++) {
			...
			int UraniumOreYCoord = random.nextInt(10);
			int UraniumOreXCoord = x + random.nextInt(16);
			int UraniumOreZCoord = z + random.nextInt(16);
			(new WorldGenMinable(Periodicraft.UraniumOre.blockID, 3, 1)).generate(world, random, UraniumOreXCoord, UraniumOreYCoord, UraniumOreZCoord);
		}
		...
		for(int k = 0; k < 5; k++) {
			...
			(new WorldGenMinable(Periodicraft.SulfurOre.blockID, 2, 1)).generate(world, random, SulfurOreXCoord, SulfurOreYCoord, SulfurOreZCoord);
		}
		...
		for(int k = 0; k < 10; k++) {
			...
			(new WorldGenMinable(Periodicraft.ScandiumOre.blockID, 3, 1)).generate(world, random, ScandiumOreXCoord, ScandiumOreYCoord, ScandiumOreZCoord);
		}
		...
		for(int k = 0; k < 8; k++) {
			...
			int RutheniumOreXCoord = x + random.nextInt(16);
			int RutheniumOreYCoord = random.nextInt(35);
			int RutheniumOreZCoord = z + random.nextInt(16);
			(new WorldGenMinable(Periodicraft.RutheniumOre.blockID, 3, 1)).generate(world, random, RutheniumOreXCoord, RutheniumOreYCoord, RutheniumOreZCoord);
		}

		for(int k = 0; k < 6; k++) {

			int HafniumOreXCoord = x + random.nextInt(16);
			int HafniumOreYCoord = random.nextInt(35);
			int HafniumOreZCoord = z + random.nextInt(16);
			(new WorldGenMinable(Periodicraft.HafniumOre.blockID, 2, 1)).generate(world, random, HafniumOreXCoord, HafniumOreYCoord, HafniumOreZCoord);
		}
	}
	...
	private void generateNether(World world, Random random, int x, int z) {
		for(int k = 0; k < 50; k++) {
			...
			int FireStoneOreXCoord = x + random.nextInt(16);
			int FireStoneOreYCoord = random.nextInt(80);
			int FireStoneOreZCoord = z + random.nextInt(16);
			(new WorldGenMinable(Periodicraft.FireStoneOre.blockID, 8, 1)).generate(world, random, FireStoneOreXCoord, FireStoneOreYCoord, FireStoneOreZCoord);
		}
	}
