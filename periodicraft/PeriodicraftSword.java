...
public class PeriodicraftSword extends PeriodicraftItem  {

    private int weaponDamage;
    private final EnumPeriodicraftToolMaterial toolMaterial;
	
	public PeriodicraftSword(int par1, EnumPeriodicraftToolMaterial par2EnumToolMaterial) {
		super(par1);
