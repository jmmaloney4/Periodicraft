...
public class TeleporterPeriodicraft extends Teleporter
{
    ...
    public TeleporterPeriodicraft(WorldServer par1WorldServer)
    {
    ...
    public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
    {
        ...
        else
        {
            for (k1 = l - short1; k1 <= l + short1; ++k1)
            {
                ...
                for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                {
                    ...
                    {
                        if (this.worldServerInstance.getBlockId(k1, i2, l1) == Periodicraft.MoonPortal.blockID)
                        {
                            while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == Periodicraft.MoonPortal.blockID)
                            {
                                --i2;
                            }
        ...
        if (d3 >= 0.0D)
        {
            ...
            if (this.worldServerInstance.getBlockId(i - 1, j, k) == Periodicraft.MoonPortal.blockID)
            {
                j2 = 2;
            }
            ...
            if (this.worldServerInstance.getBlockId(i, j, k - 1) == Periodicraft.MoonPortal.blockID)
            {
                j2 = 3;
            }
