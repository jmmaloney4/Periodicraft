...
public class PeriodicraftHoe extends PeriodicraftItem {

	protected EnumPeriodicraftToolMaterial theToolMaterial;
	
	public PeriodicraftHoe(int par1, EnumPeriodicraftToolMaterial par2EnumToolMaterial) {
		super(par1);
