...
public class EntityAIArrowAttack extends EntityAIBase {
   ...
   public EntityAIArrowAttack(IRangedAttackMob p_i10050_1_, float p_i10050_2_, int p_i10050_3_, int p_i10050_4_, float p_i10050_5_) {
      ...
      if(!(p_i10050_1_ instanceof EntityLiving)) {
         throw new IllegalArgumentException("ArrowAttackGoal requires Mob implements RangedAttackMob");
      } else {
         this.field_82641_b = p_i10050_1_;
         this.field_75322_b = (EntityLiving)p_i10050_1_;
         this.field_75321_e = p_i10050_2_;
         this.field_96561_g = p_i10050_3_;
         this.field_75325_h = p_i10050_4_;
         this.field_96562_i = p_i10050_5_;
         this.field_82642_h = p_i10050_5_ * p_i10050_5_;
         this.func_75248_a(3);
      }
   }
