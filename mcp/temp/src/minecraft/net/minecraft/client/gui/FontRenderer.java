...
public class FontRenderer {
   ...
   public FontRenderer(GameSettings p_i3067_1_, String p_i3067_2_, RenderEngine p_i3067_3_, boolean p_i3067_4_) {
      this.field_98307_f = p_i3067_2_;
      this.field_78298_i = p_i3067_3_;
      this.field_78293_l = p_i3067_4_;
      this.func_98304_a();
      p_i3067_3_.func_98187_b(p_i3067_2_);
   ...
   private void func_98305_c(String p_98305_1_) {
      BufferedImage var2;
      try {
      ...
      while(var6 < 256) {
         ...
         while(true) {
            ...
            this.field_78286_d[var6] = var9 + 2;
            ++var6;
            break;
         }
      }
   ...
   private void func_98306_d() {
      try {
         InputStream var1 = Minecraft.func_71410_x().field_71418_C.func_77292_e().func_77532_a("/font/glyph_sizes.bin");
   ...
   private float func_78266_a(int p_78266_1_, boolean p_78266_2_) {
      ...
      this.field_78298_i.func_98187_b(this.field_98307_f);
   ...
   private void func_78257_a(int p_78257_1_) {
      ...
      this.field_78298_i.func_98187_b(var2);
   }
