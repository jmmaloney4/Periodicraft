...
@Mod(modid="Periodicraft", name="Periodicraft", version="Alpha 1.0.1")
...
public class Periodicraft {
	...
	public static CreativeTabs tabElements = new CreativeTabs("tabElements") {
        public ItemStack getIconItemStack() {
                return new ItemStack(Periodicraft.PhosphorusShard, 1, 0);
        }
	};
	...
	//Blocks
	public static Block CopperOre = new BlockCopperOre(ID.id(), 190, Material.rock);
	public static Block CarbonOre = new BlockCarbonOre(ID.id(), 42, Material.rock);
	public static Block TungstenOre = new BlockTungstenOre(ID.id(), 27, Material.rock);
	public static Block PlatinumOre = new BlockPlatinumOre(ID.id(), 189, Material.rock);
	public static Block TitaniumOre = new BlockTitaniumOre(ID.id(), 187, Material.rock);
	public static Block NeodymiumOre = new BlockNeodymiumOre(ID.id(), 191, Material.rock);
	public static Block MoonStone = new BlockMoonStone(ID.id(), Material.sand);
	public static Block BlueStone = new BlockBlueStone(ID.id(), 18, Material.rock);
	public static Block TinOre = new BlockTinOre(ID.id(), 000, Material.rock);
	public static Block BerylliumOre = new BlockBerylliumOre(ID.id(), Material.rock);
	public static Block LithiumOre = new BlockLithiumOre(ID.id(), Material.rock);
	public static Block NickelOre = new BlockNickelOre(ID.id(), Material.rock);
	public static Block SilverOre = new BlockSilverOre(ID.id(), Material.rock);
	public static Block SiliconSand = new BlockSiliconSand(ID.id(), Material.sand);
	public static Block PoloniumOre = new BlockPoloniumOre(ID.id(), Material.rock);
	public static Block AluminumOre = new BlockAluminumOre(ID.id(), Material.rock);
	public static Block MagnesiumOre = new BlockMagnesiumOre(ID.id(), Material.rock);
	public static Block SodiumOre = new BlockSodiumOre(ID.id(), Material.rock);
	public static Block PhosphorusOre = new BlockPhosphorusOre(ID.id(), Material.rock);
	public static Block SulfurOre = new BlockSulfurOre(ID.id(), Material.rock);
	public static Block ScandiumOre = new BlockScandiumOre(ID.id(), Material.rock);
	public static Block VanadiumOre = new BlockVanadiumOre(ID.id(), Material.rock);
	public static Block BoronOre = new BlockBoronOre(ID.id(), Material.rock);
	public static Block ChromiumOre = new BlockChromiumOre(ID.id(), Material.rock);
	public static Block ManganeseOre = new BlockManganeseOre(ID.id(), Material.rock);
	public static Block CobaltOre = new BlockCobaltOre(ID.id(), Material.rock);
	public static Block ZincOre = new BlockZincOre(ID.id(), Material.rock);
	...
	public final static Item TitaniumPickaxe = new ItemTitaniumPickaxe(ID.id(), EnumToolMaterial.TITANIUM);
	public final static Item TitaniumSword = new ItemTitaniumSword(ID.id(), EnumToolMaterial.TITANIUM);
	public final static Item TitaniumAxe = new ItemTitaniumAxe(ID.id(), EnumToolMaterial.TITANIUM);
	public static final Item TitaniumHoe = new ItemTitaniumHoe(ID.id(), EnumToolMaterial.TITANIUM);
	public static final Item TitaniumShovel = new ItemTitaniumShovel(ID.id(), EnumToolMaterial.TITANIUM);
	...
	public final static Item IceCutter = new ItemIceCutter(ID.id(), 2, EnumToolMaterial.IRON, ItemIceCutter.blocksEffectiveAgainst);
	...
	public static final Item TungstenSword = new ItemTungstenSword(ID.id(), EnumToolMaterial.TUNGSTEN);
	...
	public static Block ManganeseCrystal = new BlockManganeseCrystal(ID.id());
	...
	public static final Item CopperPickaxe = new ItemCopperPickaxe(ID.id(), EnumToolMaterial.COPPER);
	public static final Item CopperSword = new ItemCopperSword(ID.id(), EnumToolMaterial.COPPER);
	public static final Item CopperShovel = new ItemCopperShovel(ID.id(), EnumToolMaterial.COPPER);
	public static final Item CopperAxe = new ItemCopperAxe(ID.id(), EnumToolMaterial.COPPER);
	public static final Item CopperHoe = new ItemCopperHoe(ID.id(), EnumToolMaterial.COPPER);
	...
	public static final Item TungstenPickaxe = new ItemTungstenPickaxe(ID.id(), EnumToolMaterial.TUNGSTEN);
	public static final Item TungstenHoe = new ItemTungstenHoe(ID.id(), EnumToolMaterial.TUNGSTEN);
	public static final Item TungstenAxe = new ItemTungstenAxe(ID.id(), EnumToolMaterial.TUNGSTEN);
	public static final Item TungstenShovel = new ItemTungstenShovel(ID.id(), EnumToolMaterial.TUNGSTEN);
	public static final Block SteelBlock = new BlockSteelBlock(ID.id(), Material.iron);
	public static final Item SteelSword = new ItemSteelSword(ID.id(), EnumToolMaterial.STEELSWORD);
    ...
    public void load(FMLInitializationEvent event) {
    	...
    	GameRegistry.addBiome(BiomeIronZone.IronZone);
    	BiomeDictionary.registerBiomeType(BiomeIronZone.IronZone, Type.MAGICAL, Type.PLAINS, Type.HILLS);
