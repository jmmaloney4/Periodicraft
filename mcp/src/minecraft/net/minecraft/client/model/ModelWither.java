...
public class ModelWither extends ModelBase
{
    ...
    {
        EntityWither entitywither = (EntityWither)par1EntityLiving;

        for (int i = 1; i < 3; ++i)
        {
            this.field_82904_b[i].rotateAngleY = (entitywither.func_82207_a(i - 1) - par1EntityLiving.renderYawOffset) / (180F / (float)Math.PI);
