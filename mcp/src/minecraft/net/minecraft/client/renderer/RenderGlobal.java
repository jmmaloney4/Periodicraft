...
public class RenderGlobal implements IWorldAccess
{
    ...
    public int sortAndRender(EntityLiving par1EntityLiving, int par2, double par3)
    {
        ...
        double d1 = par1EntityLiving.lastTickPosX + (par1EntityLiving.posX - par1EntityLiving.lastTickPosX) * par3;
        double d2 = par1EntityLiving.lastTickPosY + (par1EntityLiving.posY - par1EntityLiving.lastTickPosY) * par3;
        double d3 = par1EntityLiving.lastTickPosZ + (par1EntityLiving.posZ - par1EntityLiving.lastTickPosZ) * par3;
        double d4 = par1EntityLiving.posX - this.prevSortX;
            ...
            do
            {
                ...
                for (int k1 = j1; k1 < l; ++k1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            float f3 = MathHelper.sqrt_float(this.sortedWorldRenderers[k1].distanceToEntitySquared(par1EntityLiving));
    ...
    private int renderSortedRenderers(int par1, int par2, int par3, double par4)
    {
        ...
        EntityLiving entityliving = this.mc.renderViewEntity;
        double d1 = entityliving.lastTickPosX + (entityliving.posX - entityliving.lastTickPosX) * par4;
        double d2 = entityliving.lastTickPosY + (entityliving.posY - entityliving.lastTickPosY) * par4;
        double d3 = entityliving.lastTickPosZ + (entityliving.posZ - entityliving.lastTickPosZ) * par4;
        int k1 = 0;
        int l1;
    ...
    public boolean updateRenderers(EntityLiving par1EntityLiving, boolean par2)
    {
        ...
        for (k = 0; k < i; ++k)
        {
            ...
            if (worldrenderer != null)
            {
                if (!par2)
                {
                    if (worldrenderer.distanceToEntitySquared(par1EntityLiving) > 256.0F)
                    {
    ...
    public void drawSelectionBox(EntityPlayer par1EntityPlayer, MovingObjectPosition par2MovingObjectPosition, int par3, ItemStack par4ItemStack, float par5)
    {
        if (par3 == 0 && par2MovingObjectPosition.typeOfHit == EnumMovingObjectType.TILE)
        {
            ...
            if (j > 0)
            {
                ...
                double d0 = par1EntityPlayer.lastTickPosX + (par1EntityPlayer.posX - par1EntityPlayer.lastTickPosX) * (double)par5;
        ...
        if (this.mc != null && this.mc.renderViewEntity != null && this.mc.effectRenderer != null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        entityfx = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.snowball, this.renderEngine);
                    }
                    ...
                    {
                        entityfx = new EntityBreakingFX(this.theWorld, par2, par4, par6, Item.slimeBall, this.renderEngine);
                    }
                    ...
                    else if (par1Str.startsWith("iconcrack_"))
                    {
                        ...
                        entityfx = new EntityBreakingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Item.itemsList[j], this.renderEngine);
                    }
                    else if (par1Str.startsWith("tilecrack_"))
                    {
                        ...
                        entityfx = (new EntityDiggingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Block.blocksList[k], 0, l, this.renderEngine)).applyRenderColor(l);
                    }
