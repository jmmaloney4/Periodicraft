...
public class GuiConnecting extends GuiScreen
{
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        if (this.clientHandler == null)
        {
            this.drawCenteredString(this.fontRenderer, stringtranslate.translateKey("connect.connecting"), this.width / 2, this.height / 2 - 50, 16777215);
            this.drawCenteredString(this.fontRenderer, "", this.width / 2, this.height / 2 - 10, 16777215);
        }
        else
        {
            this.drawCenteredString(this.fontRenderer, stringtranslate.translateKey("connect.authorizing"), this.width / 2, this.height / 2 - 50, 16777215);
