...
public class GuiMemoryErrorScreen extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiSmallButton(0, this.width / 2 - 155, this.height / 4 + 120 + 12, stringtranslate.translateKey("gui.toMenu")));
        this.buttonList.add(new GuiSmallButton(1, this.width / 2 - 155 + 160, this.height / 4 + 120 + 12, stringtranslate.translateKey("menu.quit")));
    }
