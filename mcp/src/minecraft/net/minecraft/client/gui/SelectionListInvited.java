...
class SelectionListInvited extends SelectionListBase
{
    ...
    {
        String s = (String)GuiScreenConfigureWorld.func_96266_d(this.field_98264_a).field_96402_f.get(par1);
        this.field_98264_a.drawString(GuiScreenConfigureWorld.func_96273_f(this.field_98264_a), s, par2 + 2, par3 + 1, 16777215);
    }
}
